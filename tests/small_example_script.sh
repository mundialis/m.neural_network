...
# Get testdata
wget https://apps.mundialis.de/testdata/testdata_for_small_example_script.zip -P ${PATH_TO_TESTDATA} --continue
unzip ${PATH_TO_TESTDATA}/testdata_for_small_example_script.zip -d ${PATH_TO_TESTDATA}
...
rm ${PATH_TO_TESTDATA}/testdata/output -rf
...
r.import input=${PATH_TO_TESTDATA}/testdata/input/dop.tif output=dop
r.import input=${PATH_TO_TESTDATA}/testdata/input/ndsm.tif output=ndsm
g.region raster=dop.1 -p
v.import input=${PATH_TO_TESTDATA}/testdata/input/ref_data_trees.gpkg output=ref_data_trees

# -- Test Addons

# Data preparation
output_dir=${PATH_TO_TESTDATA}/testdata/output/preparedata_part1
...
m.neural_network.train data_dir=${PATH_TO_TESTDATA}/testdata/output/preparedata_part2/train output_model_path=${PATH_TO_TESTDATA}/testdata/output/model output_train_metrics_path=${PATH_TO_TESTDATA}/testdata/output/model_train_metrics epochs=2 || errormsg "m.neural_network.train failed"

m.neural_network.test data_dir=${PATH_TO_TESTDATA}/testdata/output/preparedata_part2/train input_model_path=${PATH_TO_TESTDATA}/testdata/input/example_model output_path=${PATH_TO_TESTDATA}/testdata/output/model_testdata_evaluation || errormsg "m.neural_network.test failed"

m.neural_network.apply data_dir=${PATH_TO_TESTDATA}/testdata/input/preparedata_part2/apply input_model_path=${PATH_TO_TESTDATA}/testdata/input/example_model/ output_path=${PATH_TO_TESTDATA}/testdata/output/applied_model || errormsg "m.neural_network.apply failed"

# Postprocessing

m.neural_network.postprocessing.patch tiles_path=${PATH_TO_TESTDATA}/testdata/output/applied_model output=applied_model_raster  || errormsg "m.neural_network.postprocessing.patch failed"
